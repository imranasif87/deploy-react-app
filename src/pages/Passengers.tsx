...
const PassengersList: FunctionComponent<Props> = (props) => {
    const [Souls, setSouls] = useState<Souls[]>([]);
    const [data, setData] = useState<Souls[]>([]);
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const flightNumber = newSoul.flightNumber;
    ...
    const handleEditSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (newSoul.person.firstName !== '') {
                selectedSoul.person.firstName = newSoul.person.firstName
            }

            if (newSoul.person.lastName !== '') {
                selectedSoul.person.lastName = newSoul.person.lastName
            }

            if (newSoul.person.email !== '') {
                selectedSoul.person.email = newSoul.person.email
            }

            if (newSoul.person.phone !== '') {
                selectedSoul.person.phone = newSoul.person.phone
            }
            ...
            const response = await fetch(
                `https://wideroeemergencynextofkinapi.azure-api.net/WideroeEmergency/api/Soul/${selectedSoul.id}`,
                {
                    ...
                    body: JSON.stringify({
                        person: {
                            firstName: selectedSoul.person.firstName,
                            lastName: selectedSoul.person.lastName,
                            email: selectedSoul.person.email,
                            phone: selectedSoul.person.phone,
                        },
                            ...
                            <div className="container">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        name="firstName"
                                        type="text"
                                        defaultValue={selectedSoul?.person.firstName}
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        name="lastName"
                                        type="text"
                                        defaultValue={selectedSoul?.person.lastName}
                                        onChange={handleChange}
                                        maxLength={31}
                                        style={{ width: "450px" }}
                                        required
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        name="email"
                                        type="text"
                                        defaultValue={selectedSoul?.person.email}
                                        onChange={handleChange}
                                        pattern="^([\p{L}\p{P}\d+](\s)?){2,31}$"
                                        maxLength={31}
                                        style={{ width: "450px" }}
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        name="phone"
                                        type="text"
                                        defaultValue={selectedSoul?.person.phone}
                                        onChange={handleChange}
                                        pattern="^([\p{L}\p{P}\d+](\s)?){2,31}$"
                                        maxLength={31}
                                        style={{ width: "450px" }}
