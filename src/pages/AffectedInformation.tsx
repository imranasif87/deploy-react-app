...
const AffectedInformation: FunctionComponent<Props> = (props) => {
  ...
  const [timeOfHotel, setTimeOfHotel] = useState(null);
  ...
  const [data, setData] = useState<Affected>({
    id: 0,
    person: {
      id: 0,
      firstName: "",
  ...
  const fetchAffectedData = (id: string) => {
